    ...
    <body class="colorbody">
        <nav class="navbar navbar-dark bg-primary">
            ...
            <div class="form-group text-center">
                <h5 style="text-align: center; font-family: 'Forte Forward', cursive; font-size: 30px; color: black;"><strong>En Fatilu Market</strong></h5>
            </div>
...
// Si no, usar el valor de textApellidoid como documento
                        ...
                        st.executeUpdate("insert into persona( "
                                ...
                                + "'" + textDireccionid + "',"
                                + "'" + textTelefonoid + "','" + "-" + "','" + "-" + "',"
                                + "'" + "0" + "','" + "3" + "','" + fechaHoraActual + "','"+CodIdent+"',0);");
                    ...
                    response.sendRedirect("Interfazproveedor.jsp");
                }
            }
        %>
