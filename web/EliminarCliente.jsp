    ...
    <body class="colorbody">
        <nav>
            <div class="form-group text-center">
                <p style="color: black; font-family: 'Forte Forward' cursive;text-align: center;  font-size: 30px;"><strong>Busque el cliente para eliminar o dar de baja!!</strong></p>
                <form action="EliminarCliente.jsp" method="post" style="text-align: center;">
        ...
        <div class="container2 col-lg-5">
            <form action="EliminarCliente.jsp" method="post">
                ...
                <div class="form-group"><input style="position: center" class="btn btn-info bnt-block" type="submit" name="guardar" value="Eliminar Cliente"></div>
            </form>            
        </div>
<%
