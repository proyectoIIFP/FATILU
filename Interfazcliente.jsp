...
<html>
    ...
    <body>
        ...
        <div style="font-family: 'Forte Forward', cursive;" class="factura">
            ...
            <h2 style="font-family: 'Forte Forward', cursive;">Clientes de FatiluMarket</h2>
            <!-- Formulario de Búsqueda -->
            <form action="Interfazcliente.jsp" method="post" style="text-align: center;">
                ...
                <a id="negrita" href="Registrocliente.jsp" style="color: orange" >Agregar Cliente.</a>
                <a id="negrita" href="ModificarCliente.jsp" style="color: orange" >Modificar Cliente.</a>
                <a id="negrita" href="EliminarCliente.jsp" style="color: orange" >Eliminar Cliente.</a>        
            </form>
            <%
                try {
                    Connection con = null;
                    ...
                    out.println("<td width=\"15%\"style=\"background-color: #777\">Nombre y Apellido </td>");
                    ...
                    out.println("<td width=\"10%\"style=\"background-color: #777\">Celular </td>");
                    out.println("<td width=\"10%\"style=\"background-color: #777\">Limite Credito </td>");
                    out.println("<td width=\"35%\"style=\"background-color: #777\">Acceso </td>");
                    out.println("<td width=\"10%\"style=\"background-color: #777\">Contraseña </td>");
                    out.println("</tr>");
                    ResultSet r;
                   if (request.getParameter("accion") != null) {
                        String terminoBusqueda = request.getParameter("terminoBusqueda");
                        r = st.executeQuery("select * from persona where tipopersona_codigo=2 and nombre = '"+terminoBusqueda+"' and estado=0");
                    } else {
                           r = st.executeQuery("select * from persona where tipopersona_codigo=2 and estado=0  order by codigo");
                    }
                   while (r.next()) {
                        out.println("<tr>");
                        ...
                        out.println("<td widh=\"15%\"style=\"background-color: white\">" + r.getString(9) + "</td>");
                        out.println("<td widh=\"15%\"style=\"background-color: white\">" + r.getString(8) + "</td>");
                        out.println("<td widh=\"15%\"style=\"background-color: white\">" + r.getString(7) + "</td>");
                        out.println("</tr>");
                    }
                } catch (Exception e) {
                    out.print(e);
